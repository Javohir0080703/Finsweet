...
const LetsBuild = () => {
  ...
  return (
    <section className='pb-[128px] bg-white z-0'>
        ...
        <Link to="/contact" onClick={handleButtonClick}  className='block w-full max-w-[233px] rounded-[41px] mx-auto bg-#FCD980 py-2 aaa:py-4 px-5 aaa:px-[66px] text-center text-#1B1C2B text-lg font-semibold leading-8'>Contact Us</Link>
        </div>
    </section>
  )
}
