            ...
            <div className='containerb block qqq:flex items-center justify-between'>
                <div>
                    ...
                    <div className='sss:flex block space-y-5 sss:space-y-0 items-center'>
                        <Link to="/pricing" onClick={handleButtonClick} className=' w-full text-center max-w-[189px] qqq:max-w-[240px]  qqq:mx-0 mx-auto  block  text-#1B1C2B text-sm eee:text-lg font-semibold leading-6 eee:leading-8 bg-#FCD980 py-3 eee:py-4 px-6 eee:px-[30px] sss:px-[56px] rounded-[41px]'>
                            View our work
                        </Link>
                    </div>
                </div>
