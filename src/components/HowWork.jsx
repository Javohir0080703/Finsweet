        ...
        <section className='qqq:py-[128px] eee:py-[50px] py-8 bg-[#F4F6FC] z-0'>
            <div className='containerb block tabletmax:flex  justify-between'>
                <div className='mb-10 tabletmax:mb-0'>
                    ...
                    <Link onClick={handleButtonClick} to="/contact" className='text-#2405F2 text-sm  aaa:text-lg font-medium leading-8 flex  items-center  justify-center'>
                ...
                <ul className='grid grid-cols-1 eee:grid-cols-2 gap-y-12 gap-x-6 w-full max-w-[628px] mx-auto tabletmax:mx-0'>
                    {
                        homework.map((work) => {
                            return (
                                <li key={work.id} className='w-full max-w-[303px] mx-auto eee:mx-0' >
                                 <div className=' relative mb-4 w-full max-w-[50px] mx-auto eee:mx-0'>
                                    <img className='bg-#1C1E53 rounded-xl' src={MaskGroup} alt={work.id} />
