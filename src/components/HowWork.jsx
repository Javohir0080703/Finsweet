        ...
        <section className='py-[128px] bg-[#F4F6FC] z-0'>
            <div className='containerb block tabletmax:flex  justify-between'>
                <div className='mb-10 tabletmax:mb-0'>
                    ...
                    <Link onClick={handleButtonClick} to="/contact" className='text-#2405F2 text-lg font-medium leading-8 flex  items-center  w-full max-w-[244px] mx-auto tabletmax:mx-0'>
