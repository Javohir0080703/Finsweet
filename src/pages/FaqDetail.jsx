    ...
    return (
       <div>
         <section className='py-[128px] bg-white z-0'>
            ...
            <p className='text-#282938 text-2xl font-medium leading-9 opacity-[0.8] mb-3'>{faqData.detailTitle}</p>
            <h2 className='text-#282938 text-5xl font-semibold  leading-[64px] mb-4 w-full max-w-[646px]'>{faqData.detailTheme}</h2>
            <p className='text-#282938 text-base font-medium w-full max-w-[817px] mb-12'>{faqData.detailText}</p>
            ...
            <h2 className='text-#282938 text-[38px] font-semibold leading-[56px] mb-3'>About the project</h2>
            <p className='text-#282938 text-base leading-7 opacity-[0.7] w-full max-w-[834px] mb-6'>{faqData.detailAbout}</p>
            ...
            <h2 className='text-#282938 text-[38px] font-semibold leading-[56px] mb-3'>How we do it</h2>
            <p className='text-#282938 text-base leading-7 opacity-[0.7] w-full max-w-[834px] mb-6'>{faqData.detailHow}</p>
            <ul className='space-y-4 pl-4 mb-16'>
                <li className='list-disc text-#282938 text-base leading-7 opacity-[0.7] '>
                      {faqData.detailHow1}
                </li>
